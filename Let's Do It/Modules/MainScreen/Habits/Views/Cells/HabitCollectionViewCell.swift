...
class HabitCollectionViewCell: UICollectionViewCell {
    ...
    var index: IndexPath?
    private var habitTitle = UILabel(text: "Food", font: .appleSDGothicNeo20(), alignment: .left)
    private let habitBody = UILabel(text: "Healthy food", font: .appleSDGothicNeoDemiBold20(), alignment: .left)
...
extension HabitCollectionViewCell {
    ...
    private func setUI() {
        backgroundColor = #colorLiteral(red: 1, green: 0.9575918005, blue: 0.01449212246, alpha: 0.5212755268)
