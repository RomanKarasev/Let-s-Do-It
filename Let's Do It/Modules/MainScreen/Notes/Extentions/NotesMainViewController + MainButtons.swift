...
class NotesMainButtons {
    ...
    lazy var allNotesButton: UIButton = {
        ...
        NSLayoutConstraint.activate(
            [nameAllFolderLabel.topAnchor.constraint(equalTo: button.topAnchor, constant: 5),
        ...
        NSLayoutConstraint.activate(
            [countAllFolderLabel.bottomAnchor.constraint(equalTo: button.bottomAnchor, constant: -2),
    ...
    lazy var repeatedNotesButton: UIButton = {
        ...
        NSLayoutConstraint.activate(
            [repeatedNotesFolderLabel.topAnchor.constraint(equalTo: button.topAnchor, constant: 5),
        ...
        NSLayoutConstraint.activate(
            [countRepeatedNotesFolderLabel.bottomAnchor.constraint(equalTo: button.bottomAnchor, constant: -2),
