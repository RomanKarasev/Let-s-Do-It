...
class AllNotesViewCell: UITableViewCell {
    ...
    let noteTitle = UILabel(text: "Note", font: .appleSDGothicNeoDemiBold14(), alignment: .left)
    
    let noteBody: UILabel = {
        let noteBody = UILabel(text: "Notes will be here", font: .appleSDGothicNeo20(), alignment: .left)
        noteBody.numberOfLines = 0
        noteBody.lineBreakMode = .byWordWrapping
        noteBody.translatesAutoresizingMaskIntoConstraints = false
        return noteBody
    }()
    let noteTime = UILabel(text: "00:00 - 00:00", font: .appleSDGothicNeo14(), alignment: .left)
    let noteDate = UILabel(text: "7.01.1991", font: .appleSDGothicNeo14(), alignment: .left)
    var index: IndexPath?
    ...
    func setConstraints() {
        let timeStackView = UIStackView(arrangedSubviews: [noteDate, noteTime], axis: .vertical, spacing: 2, distribution: .fillProportionally)
        
        self.addSubview(verticalDividerNotesImage)
        NSLayoutConstraint.activate([verticalDividerNotesImage.topAnchor.constraint(equalTo: self.topAnchor, constant: 5),
        ...
        NSLayoutConstraint.activate([noteTitle.topAnchor.constraint(equalTo: self.topAnchor, constant: 10),
        ...
        NSLayoutConstraint.activate([timeStackView.leadingAnchor.constraint(equalTo: verticalDividerNotesImage.trailingAnchor, constant: 5),
        ...
        NSLayoutConstraint.activate([noteBody.topAnchor.constraint(equalTo: noteTitle.bottomAnchor, constant: 2),
