...
class TableHeaderView: UIView {
    ...
    func setConstraints() {
        ...
        NSLayoutConstraint.activate([weatherImageView.centerYAnchor.constraint(equalTo: self.centerYAnchor),
        ...
        NSLayoutConstraint.activate([weatherRealTemperatureLabel.centerXAnchor.constraint(equalTo: self.centerXAnchor),
        ...
        NSLayoutConstraint.activate([feelTemperatureLabel.centerXAnchor.constraint(equalTo: self.centerXAnchor),
        ...
        NSLayoutConstraint.activate([weatherTemperatureLabel.centerXAnchor.constraint(equalTo: self.centerXAnchor),
        ...
        NSLayoutConstraint.activate([temperatureLabel.centerXAnchor.constraint(equalTo: self.centerXAnchor),
        ...
        NSLayoutConstraint.activate([showHourlyWeatherVCButton.bottomAnchor.constraint(equalTo: self.bottomAnchor),
        ...
        NSLayoutConstraint.activate([viewForButton.bottomAnchor.constraint(equalTo: showHourlyWeatherVCButton.topAnchor, constant: 2),
    ...
    func setWeatherData(from model: CurrentWeatherData) {
        DispatchQueue.main.async {
            ...
            guard let temp = firstDayModelData.temp, let realTemp = firstDayModelData.appearenceTemp, let rain = firstDayModelData.clouds, let imageName = firstDayModelData.weather?.description else { return }
