...
class RemindersMainButtons {
    ...
    lazy var missedRemindersButton: UIButton = {
        ...
        NSLayoutConstraint.activate(
            [nameMisFolderLabel.topAnchor.constraint(equalTo: button.topAnchor, constant: 5),
        ...
        NSLayoutConstraint.activate(
            [countMissFolderLabel.bottomAnchor.constraint(equalTo: button.bottomAnchor, constant: -2),
